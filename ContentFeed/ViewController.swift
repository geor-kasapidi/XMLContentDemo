...
<Root backgroundColor="#fff" alignItems="center" flexDirection="row">
    <Image bundleImageName="1.jpg" contentMode="scaleAspectFill" positionType="absolute" top="0" left="0" right="0" bottom="0" />
    <Text content="Cool\ntext 1" fontSize="40" italic="true" textBackgroundColor="#FF0000" textColor="#FFFFFF" marginLeft="20" flex="1" appearanceDelay="1" />
    ...
    <Button positionType="absolute" bottom="20" left="20" right="20" height="50" cornerRadius="12" backgroundColor="#FFFF00" alignItems="center" justifyContent="center">
        <Text content="Button" fontSize="24" textColor="#000000" flex="1" />
    </Button
</Root>
"""
